...
namespace VRStandardAssets.Utils {
    ...
    public class Reticle : MonoBehaviour {
        ...
        [SerializeField] Image m_Image;                     // Reference to the image component that represents the reticle.
        [SerializeField] Transform m_ReticleTransform;      // We need to affect the reticle's transform.
        [SerializeField] Transform m_Camera;                // The reticle is always placed relative to the camera.
